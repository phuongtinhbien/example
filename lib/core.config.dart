...
import 'src/core_module.dart' as _i8;
import 'src/device/package_service.dart' as _i7;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  await gh.factoryAsync<_i5.DeviceInfoService>(() => coreModule.deviceInfo,
      preResolve: true);
  gh.factory<_i6.FirebaseAnalytics>(() => coreModule.analytics);
  await gh.factoryAsync<_i7.PackageService>(() => coreModule.packageInfo,
      preResolve: true);
  return get;
}
